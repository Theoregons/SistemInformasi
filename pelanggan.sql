...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kasir&table=pelanggan">`kasir`.`pelanggan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kasir&table=pesanan">`kasir`.`pesanan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kasir&table=produk">`kasir`.`produk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kasir&table=user">`kasir`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=multi_user&table=user">`multi_user`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tikhealth&table=artikel">`tikhealth`.`artikel`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tikhealth&table=gambar_background">`tikhealth`.`gambar_background`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan&table=buku">`perpustakaan`.`buku`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=u5480206_kursusonline&table=voucher">`u5480206_kursusonline`.`voucher`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=app&table=users">`app`.`users`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
